...
<head>
    ...
    <title>Ubah Informasi Vaksin || {{ $information->heading }}</title>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed bg-neutral-50 rounded-lg dark:border-gray-700">
            ...
            <div class="container mx-auto px-4 pt-8">
                <h1
                    ...
                    Ubah informasi vaksin
                </h1>
            </div>
            {{-- form tambah data --}}
            <div class="container mx-auto px-4 pt-8">
                <form class="mx-auto" id="myform"
                    action="{{ route('admin.update.informasi', $information->id_information) }}" method="POST">
                    @method('PUT') @csrf
                    <div class="mb-5">
                        ...
                        <input type="text" id="judul" name="heading"
                            ...
                            placeholder="Masukkan judul" value="{{ old('heading', $information->heading) }}" />
                    </div>
                    {{-- eror heading --}}
                    @error('heading')
                        <div id="alert-1"
