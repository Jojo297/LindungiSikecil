    ...
    <div class="container px-6 mx-auto">
        <div class="flex flex-col text-center md:text-left md:flex-row h-screen justify-evenly md:items-center">
            <div class="flex flex-col w-full">
                ...
                <p class="w-5/12 mb-5 pt-2 mx-auto md:mx-0 text-gray-500">
                    Kontrol dan pantau bayi anda dari dasbor.
                </p>
            </div>
            <div class="w-full pb-5 md:w-full lg:w-9/12 mx-auto md:mx-0">
                <div class="bg-white p-10 flex flex-col w-full shadow-xl rounded-xl">
                    <h2 class="text-2xl font-bold text-gray-800 text-center mb-5">
                        Masuk
                    </h2>
                    <form method="POST" action="{{ route('login.user') }}" class="w-full">
                        @csrf
