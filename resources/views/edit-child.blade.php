...
<head>
    ...
    <title>LindungiSiKecil || Profil Anak</title>
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed bg-neutral-50 rounded-lg">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="/user/child-profile/{{ $child->id }}"
                                    class="ms-1 text-sm font-medium text-gray-700 hover:text-red-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Profil
                                    Anak</a>
                            </div>
                        </li>
            ...
            <div
                ...
                <div class="flex justify-center">
                    <h1 class="text-xl font-sans font-bold text-gray-700 mb-2 mt-3 lg:text-xl">Ubah Anak</h1>
                </div>
                <form method="POST" action="/user/profile-anak/update/{{ $child->id }}" class="lg:p-8">
                    @csrf @method('PUT')
                    {{-- input nama --}}
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-700 dark:text-white">Nama
                        anak</label>
                    <input type="text" id="name" name="name" id="disabled-input" aria-label="disabled input"
                    ...
                    @error('name')
                        <div id="alert-1"
                            class="flex items-center p-4 mb-4 mt-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                            role="alert">
                    ...
                    <div class="relative">
                        <div class="flex items-center absolute inset-y-0 start-0 ps-3.5 pointer-events-none">
                        ...
                        <input datepicker datepicker-format="yyyy/mm/dd" id="date" name="date" type="text"
                    ...
                    <div class="ml-4">
                        <div class="flex items-center mb-4 mt-3">
                            <input type="radio" value="Laki-laki" name="gender"
                                {{ $child->gender == 'Laki-laki' ? 'checked' : '' }} id="gender-1"
                        ...
                        <div class="">
                            <input type="radio" value="Perempuan" name="gender"
                                {{ $child->gender == 'Perempuan' ? 'checked' : '' }} id="gender-2"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="gender-2"
