...
<body class="bg-red-300">
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed bg-neutral-50 rounded-lg h-screen">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span
                                    class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Profile</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div
                ...
                <div class="flex justify-center">
                    <h1 class="text-xl font-sans font-bold text-gray-700 mb-2 mt-3 lg:text-xl">Profile Anda</h1>
                </div>
                <form action="" class="lg:p-8">
                    ...
                    {{-- input wa --}}
                    <label for="email" class="block mb-2 mt-4 text-sm font-medium text-gray-700 dark:text-white">No
                        Whatsapp</label>
                    <div class="flex items-center">
                        <input type="password" id="noWa" autocomplete="current-password"
                            aria-label="disabled input" aria-describedby="helper-text-explanation"
                            class="bg-gray-50 border-gray-300 text-gray-500 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed"
                            value="{{ sprintf('%s-%s-%s', substr($decryptNoWa, 0, 4), substr($decryptNoWa, 4, 4), substr($decryptNoWa, 8)) }}"
                            disabled>
                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-left: -30px; cursor: pointer;"
                            id="togglePassword" class="w-5 h-5"
                    ...
                    <div class="flex justify-center gap-5 mt-3 ">
                        <a href="/user/profile/edit/{{ Auth::user()->id_parent }}" type="submit" id="submit-button"
                        ...
                        <a href="{{ route('user.index.change.password') }}" type="submit" id="submit-button"
                            class="text-white flex mt-2 items-center bg-red-700 animate transition duration-500 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-1/2 justify-center lg:w-1/3">
                            Ubah Kata Sandi
                        </a>
                    </div>
                </form>
    ...
    <script>
        ...
        const password = document.querySelector('#noWa');
