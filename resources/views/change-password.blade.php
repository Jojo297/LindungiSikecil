...
<body class="bg-red-300">
    ...
    <div class="p-4 pt-[90px]">
        <div class="p-4 border-2 border-gray-200 border-dashed bg-neutral-50 rounded-lg ">
            ...
            {{-- data user --}}
            <div
                class="container mx-auto mb-4 border-2 border-red-300 border-dashed bg-white p-4 overflow-x-auto shadow-sm rounded-lg pt-3 lg:w-3/4">
                <div class="flex justify-center">
                    <h1 class="text-xl font-sans font-bold text-gray-700 mb-2 mt-3 lg:text-xl">Ubah Kata Sandi</h1>
                </div>
                <form action="{{ route('user.change.password') }}" id="profile-form" method="POST" class="lg:p-8">
                    @csrf
                    {{-- input password lama --}}
                    <label for="password1" class="block mb-2 text-sm font-medium text-gray-700 dark:text-white">Kata
                        sandi
                        lama</label>
                    <div class="flex items-center">
                        <input type="password" id="password1" name="password1" autocomplete="current-password"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-left: -30px; cursor: pointer;"
                            id="togglePassword1" class="w-5 h-5"
                    ...
                    @enderror
                    {{-- eror password lama selesai --}}

                    {{-- input password baru --}}
                    <label for="password2"
                        class="block mb-2 mt-4 text-sm font-medium text-gray-700 dark:text-white">Kata
                        sandi baru</label>
                    <div class="flex items-center">
                        <input type="password" id="password2" name="password2"
                            ...
                            value="{{ old('password2') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-left: -30px; cursor: pointer;"
                            id="togglePassword2" class="w-5 h-5"
                            viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path fill="#f98080"
                                d="M288 80c-65.2 0-118.8 29.6-159.9 67.7C89.6 183.5 63 226 49.4 256c13.6 30 40.2 72.5 78.6 108.3C169.2 402.4 222.8 432 288 432s118.8-29.6 159.9-67.7C486.4 328.5 513 286 526.6 256c-13.6-30-40.2-72.5-78.6-108.3C406.8 109.6 353.2 80 288 80zM95.4 112.6C142.5 68.8 207.2 32 288 32s145.5 36.8 192.6 80.6c46.8 43.5 78.1 95.4 93 131.1c3.3 7.9 3.3 16.7 0 24.6c-14.9 35.7-46.2 87.7-93 131.1C433.5 443.2 368.8 480 288 480s-145.5-36.8-192.6-80.6C48.6 356 17.3 304 2.5 268.3c-3.3-7.9-3.3-16.7 0-24.6C17.3 208 48.6 156 95.4 112.6zM288 336c44.2 0 80-35.8 80-80s-35.8-80-80-80c-.7 0-1.3 0-2 0c1.3 5.1 2 10.5 2 16c0 35.3-28.7 64-64 64c-5.5 0-10.9-.7-16-2c0 .7 0 1.3 0 2c0 44.2 35.8 80 80 80zm0-208a128 128 0 1 1 0 256 128 128 0 1 1 0-256z" />
                        </svg>
                    </div>
                    {{-- input password baru selesai --}}
                    ...
                    @enderror
                    {{-- eror password baru selesai --}}

                    {{-- input konfirmasi kata sandi --}}
                    <label for="password3"
                        class="block mb-2 mt-4 text-sm font-medium text-gray-700 dark:text-white">Konfirmasi kata sandi
                    </label>
                    <div class="flex items-center">
                        <input type="password" id="password3" name="password3"
                            ...
                            value="{{ old('password3') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-left: -30px; cursor: pointer;"
                            id="togglePassword3" class="w-5 h-5"
                            viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path fill="#f98080"
                                d="M288 80c-65.2 0-118.8 29.6-159.9 67.7C89.6 183.5 63 226 49.4 256c13.6 30 40.2 72.5 78.6 108.3C169.2 402.4 222.8 432 288 432s118.8-29.6 159.9-67.7C486.4 328.5 513 286 526.6 256c-13.6-30-40.2-72.5-78.6-108.3C406.8 109.6 353.2 80 288 80zM95.4 112.6C142.5 68.8 207.2 32 288 32s145.5 36.8 192.6 80.6c46.8 43.5 78.1 95.4 93 131.1c3.3 7.9 3.3 16.7 0 24.6c-14.9 35.7-46.2 87.7-93 131.1C433.5 443.2 368.8 480 288 480s-145.5-36.8-192.6-80.6C48.6 356 17.3 304 2.5 268.3c-3.3-7.9-3.3-16.7 0-24.6C17.3 208 48.6 156 95.4 112.6zM288 336c44.2 0 80-35.8 80-80s-35.8-80-80-80c-.7 0-1.3 0-2 0c1.3 5.1 2 10.5 2 16c0 35.3-28.7 64-64 64c-5.5 0-10.9-.7-16-2c0 .7 0 1.3 0 2c0 44.2 35.8 80 80 80zm0-208a128 128 0 1 1 0 256 128 128 0 1 1 0-256z" />
                        </svg>
                    </div>
                    {{-- input konfirmasi kata sandi selesai --}}
                    ...
                    {{-- loading --}}
                    <div align="center" id="loading-indicator" class="hidden mt-6" role="status">
