                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="/user/manage-growth/{{ $id_child }}"
                                    class="ms-1 text-sm font-medium text-gray-700 hover:text-red-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Kelola
                                    Grafik Perumbuhan Anak</a>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">
                                    Ubah Data Pertumbuhan Anak</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                    ...
                    <div class="mb-8">
                        ...
                        <div
                            ...
                            <div class="flex justify-center">
                                <h1 class="text-xl font-sans font-bold text-gray-700 mb-2 mt-3 lg:text-xl">Ubah Data
                                </h1>
                            </div>
                            <form action="/user/manage-growth-update/{{ $childGrowth->Id_growth }}" id="profile-form"
                                method="POST" class="lg:p-8">
                                @method('PUT') @csrf

                                {{-- input berat --}}
                                <label for="weight"
                                    class="block mb-2 text-sm font-medium text-gray-700 dark:text-white">Berat
                                    Badan</label>
                                <input type="text" id="weight" name="weight"
                                    aria-describedby="helper-text-explanation" maxlength="25"
                                ...
                                {{-- input panjang --}}
                                <label for="height"
                                    class="block mb-2 mt-4 text-sm font-medium text-gray-700 dark:text-white">Panjang/Tinggi
                                    Badan</label>
                                <input type="text" id="height" name="height" maxlength="25"
                                    aria-describedby="helper-text-explanation"
                                    class="bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                                    value="{{ $childGrowth->body_length }}">
                                ...
                                <label for="email"
                                    class="block mb-2 mt-4 text-sm font-medium text-gray-700 dark:text-white">Lingkar
                                    Kepala</label>
                                <input type="text" id="head" name="head" maxlength="25"
                                    aria-describedby="helper-text-explanation"
                                    class="bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                                    value="{{ $childGrowth->head_circumference }}">
                                ...
                                {{-- loading --}}
                                <div align="center" id="loading-indicator" class="hidden mt-5" role="status">
