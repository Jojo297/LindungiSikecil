                ...
                <div class="flex flex-col items-center justify-center min-h-screen">
                    <div class="bg-white p-10  flex flex-col w-full shadow-xl rounded-xl">
                        ...
                        <div class="flex flex-col items-center">
                            <p class="text-sm text-gray-600 text-center">Hitung mundur kirim ulang kode OTP:</p>
                            <p class="text-gray-600 text-center" id="countdown"></p>

                        </div>
                        <form action="{{ route('virifyOtp') }}" method="POST">
                            @csrf
                            <div
                                class="flex flex-row  items-center justify-center mt-4 mb-4 space-x-2 rtl:space-x-reverse">
                            ...
                            <div align="center" class="mt-4">
                                <button align="center" type="button" id="resend-button"
                                    class="text-white bg-blue-400 text-center cursor-not-allowed font-medium rounded-lg text-sm px-5 py-2.5"
                                    disabled>
                                    Kirim ulang
                                </button>
                            </div>
                            ...
                            <div id="button" class="flex flex-col w-full my-5">
                                <p id="helper-text-explanation"
                                    ...
                                    Masukkan 6 digit kode yang kami kirim melalui Whatsaap,</p>
                                <p
                                    class="text-xs text-center mb-2 text-gray-500 dark:text-gray-400 md:text-sm lg:text-sm">
                                    jika lebih dari <strong class="font-semibold text-gray-900"> 10 menit </strong> kode
                                    OTP akan otomatis ke reset</p>
